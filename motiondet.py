...
def detect(movingAvgImg, maskImg, image, kSize, alpha, blackThreshold, maxChange, dilateAmount, erodeAmount):
    ...
    cv2.imwrite('k/imgw'+str(indx) + '.jpg', workImg)
    ...
    cv2.imwrite('k/img'+str(indx) + '.jpg', video_image)
    indx = indx + 1
